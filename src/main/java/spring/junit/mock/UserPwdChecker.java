...
public class UserPwdChecker {
     ...
     * @return
     */
    public boolean pwdMatch(String saleNo,String password){
        if (password==null||saleNo==null){
            throw new IllegalArgumentException("saleNo or password could not be empty!");
        }
        String realPwd = userService.queryPwdBySaleNo(saleNo);
